function veh_struct = Path_generate( veh_struct, Env_struct )
...
%     H_tar = Dijistra_contain(veh_struct, Env_struct);
    ...
    A_tar = veh_struct.A_tar;
    for i = 1:size(H_tar,1)
        [partial_path,partial_action] = Astar_generate(veh_struct, Env_struct, H_tar(i,1), H_tar(i,2), H_tar(i,3), A_tar(i));
