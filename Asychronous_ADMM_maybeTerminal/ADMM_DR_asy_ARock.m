function [z_out,tag,test_save, rho_mat, time_mat, A_set_save] = ADMM_DR_asy_ARock( f, g, rel_mat, rho, max_step, epsi_rel, epsi_abs, accuracy, empty_tag )
...
%             
%             % scheme 3
%             BA = randperm(c_size-p_size);
%             A_set = [1:p_size, p_size+BA(1)];
